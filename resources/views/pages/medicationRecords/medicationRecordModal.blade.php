        ...
        <div
            ...
            <div class="modal-body relative p-4">
                <div class="grid mx-10">
                    <p>　就醫日：<a id="modal_redate"></a></p>
                    <p>處方醫院：<a id="modal_pres_hosp"></a></p>
                    <p>調劑醫院：<a id="modal_disp_hosp"></a></p>
                    <p>保險類型：<a id="modal_insurance_type"></a></p>
                </div>
                                    ...
                                    <table class="min-w-full text-center">
                                        ...
                                        <tr class="bg-white border-b">
                                            <td class="px-6 py-2 whitespace-nowrap text-sm font-medium text-gray-900">
                                                <a id="modal_indication"></a>
                                            </td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-2 whitespace-nowrap">
                                                <a id="modal_category"></a>
                                            </td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-2 whitespace-nowrap">
                                                <a id="modal_trade_name"></a>
                                            </td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-2 whitespace-nowrap">
                                                <a id="modal_generic_name"></a>
                                            </td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-2 whitespace-nowrap">
                                                <a id="modal_dose"></a>
                                            </td>
                                            ...
                                            <td class="text-sm text-gray-900 font-light px-6 py-2 whitespace-nowrap">
                                                <a id="modal_pres_day"></a>
                                            </td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-2 whitespace-nowrap">
                                                <a id="modal_total_amount"></a>
                                            </td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-2 whitespace-nowrap">
                                                <a id="modal_note"></a>
                                            </td>
