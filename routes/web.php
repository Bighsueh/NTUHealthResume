...
Route::group(['prefix' => 'medication_management', 'middleware' => ['login']], function () {
    ...
    //取得藥師回饋單內容
    Route::post('/get_pharmacist_feedback_data', [MedicationRecordController::class, 'get_pharmacist_feedback_data'])
        ->name('get_medication_management_pharmacist_feedback_data');
    //儲存其他資訊內容
    ...
    //取得藥歷列表資訊(taskDetail.blade)
    Route::post('/get_medication_detail_data',[MedicationRecordController::class,'get_medication_data'])
        ->name('get_medication_detail_data');
